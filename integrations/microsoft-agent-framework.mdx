...
Get your API key from the [Dashboard](https://deepinfra.com/dash/api_keys) and export it as `DEEPINFRA_API_KEY`.
...
var apiKey = Environment.GetEnvironmentVariable("DEEPINFRA_API_KEY")
    ?? throw new InvalidOperationException("DEEPINFRA_API_KEY is not set.");
