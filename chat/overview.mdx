...
| `max_tokens` | Max tokens to generate. Defaults to the model's max context length minus input length, or 16384, whichever is smaller |
...
For the complete parameter reference, see the [API reference](https://docs.deepinfra.com/api-reference/openai-chat-completions).
