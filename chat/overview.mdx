...
DeepInfra offers an OpenAI-compatible API for all [LLM models](https://deepinfra.com/models/text-generation) at the best prices for open-source model inference. The endpoint is:
