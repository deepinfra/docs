...
Go to the [Dashboard](https://deepinfra.com/dash/api_keys) and create an API key (new to DeepInfra? See [Signing In](/account/signing-in)). Copy it when it is shown and export it, so the examples below can read it:
