---
title: Models
description: Browse 200+ open-source models available on DeepInfra.
icon: brain
---
...
- **[Text generation / LLMs](https://deepinfra.com/models/text-generation)** — DeepSeek, Qwen, GLM, Kimi, Gemma, Nemotron, and more
- **[Embeddings](https://deepinfra.com/models/embeddings)** — Qwen3 Embedding, BAAI/bge, sentence-transformers, and more
- **[Rerankers](https://deepinfra.com/models/reranker)** — Qwen3 Reranker and more, for RAG pipelines
- **[Vision / multimodal](https://deepinfra.com/models/multimodal)** — Qwen3-VL, Gemma 4, Kimi K3, and more
- **[OCR](https://deepinfra.com/models/ocr)** — Specialized models for document text extraction
- **[Text to image](https://deepinfra.com/models/text-to-image)** — FLUX, Qwen-Image, Nano Banana, and more
