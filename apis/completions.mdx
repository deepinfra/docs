...
The example below uses `deepseek-ai/DeepSeek-V4-Flash-0731` with its prompt format:
...
For the complete parameter reference, see the [API reference](/api-reference/text-completions/openai-completions).
