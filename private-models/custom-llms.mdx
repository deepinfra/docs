---
title: Custom LLMs
description: Deploy your own LLM on dedicated A100/H100/H200/B200 GPUs with autoscaling and an OpenAI-compatible endpoint.
icon: robot
---
...
| `gpu` | `A100-80GB` or `H100-80GB` (more options available) |
