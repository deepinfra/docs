...
<CardGroup cols={2}>
  <Card title="Custom LLMs" icon="robot" href="/private-models/custom-llms">
    Deploy any Hugging Face LLM on A100/H100/H200/B200 GPUs with the OpenAI-compatible API.
  </Card>
...
- **A100-80GB** — proven workhorse for LLM inference
- **H100-80GB** — latest NVIDIA flagship, 2x faster than A100 for many workloads
- **H200** — H100 with 141GB HBM3e memory, ideal for large models
- **B200** — next-generation Blackwell GPU
